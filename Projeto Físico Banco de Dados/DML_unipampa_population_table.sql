...
INSERT INTO 
	Escola (inep, nome, localizacaoId, esferaGovId, municipioId)
VALUES 
	(11000708, 'ESCOLA MUNICIPAL DE ENSINO FUNDAMENTAL DOUTOR CUSTODIO', 1, 3, 1),
	(11000864, 'EEEFM IRMA MARIA CELESTE', 1, 2, 2),
	(11001160, 'ESC VISCONDE DO RIO BRANCO', 2, 1, 1),
	(11002255, 'ESC SANTA CLARA', 2, 1, 3),
	(11002280, 'ESC PROFESSORA SOFIA BARBOSA', 1, 2, 4),
	(11002883, 'ESCOLA ESTADUAL PROF GILBERTO MESTRINHO', 2, 2, 5),
	(11003693, 'ESC MUL MANOEL RIBEIRO ROSA', 1, 3, 9),
	(11007443, 'ESC MUL ODILON NERE SAMPAIO', 2, 3, 10),
	(11010126, 'ESCOLA MUNICIPAL SOUZA LIMA', 2, 3, 10),
	(11039779, 'EM CLARINOPOLIS', 1, 1, 9),
	(11053402, 'EM INDIGENA RAMAO MARTINS', 2, 3, 6)
